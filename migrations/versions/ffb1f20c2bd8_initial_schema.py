...
def upgrade() -> None:
    ...
    with op.batch_alter_table("admin_users", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_admin_users_username"), ["username"], unique=True
        )
    ...
    with op.batch_alter_table("model_group_items", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_model_group_items_channel_id"), ["channel_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_model_group_items_credential_id"),
            ["credential_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_model_group_items_group_id"), ["group_id"], unique=False
        )
    ...
    with op.batch_alter_table("model_groups", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_model_groups_name"), ["name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_model_groups_protocol"), ["protocol"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_model_groups_route_group_id"),
            ["route_group_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("request_logs", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_request_logs_channel_id"), ["channel_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_request_logs_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_request_logs_gateway_key_id"),
            ["gateway_key_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_request_logs_protocol"), ["protocol"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_request_logs_resolved_group_name"),
            ["resolved_group_name"],
            unique=False,
        )
    ...
    with op.batch_alter_table("site_base_urls", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_site_base_urls_site_id"), ["site_id"], unique=False
        )
    ...
    with op.batch_alter_table("site_credentials", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_site_credentials_site_id"), ["site_id"], unique=False
        )
    ...
    with op.batch_alter_table("site_discovered_models", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_site_discovered_models_credential_id"),
            ["credential_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_site_discovered_models_protocol_config_id"),
            ["protocol_config_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("site_protocol_configs", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_site_protocol_configs_protocol"), ["protocol"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_site_protocol_configs_site_id"), ["site_id"], unique=False
        )
    ...
    with op.batch_alter_table(
        "site_protocol_credential_bindings", schema=None
    ) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_site_protocol_credential_bindings_credential_id"),
            ["credential_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_site_protocol_credential_bindings_protocol_config_id"),
            ["protocol_config_id"],
            unique=False,
        )
